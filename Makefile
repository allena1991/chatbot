...
verbatim:
	...
	At the end of your turn, you should provide a summary.
	  ...
	  - Use the <markdown_spec>, link and citation rules where relevant. You must use the summary when you mention files, directories, functions, etc (e.g. `app/components/Card.tsx`).
	...
	- Bullet lists (which should be formatted with '- ' instead of '• ') should also have **bold markdown** as a pseudo-heading, especially if there are sub-bullets. Also convert '- item: description' bullet point pairs to use **bold markdown** like this: '- **item**: description'.
